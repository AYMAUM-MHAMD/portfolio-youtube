    ...
    <section id="home" className="grid md:grid-cols-12 items-center gap-6">
      ...
      <div className="md:col-span-6 flex flex-col items-center md:items-start gap-y-4">
        ...
        <p className="leading-7 md:text-lg md:max-w-[85%] text-center md:text-start">
          ...
          dolorem ad necessitatibus laboriosam incidunt modi fugiat at,
          suscipit, explicabo facere odio quia facilis aliquid blanditiis
          cupiditate consequatur doloribus omnis recusandae!
        </p>
      ...
      <div className="md:col-span-5 grid place-content-center">
        <div className="relative  flex items-center justify-center size-80 md:size-96">
          ...
          <Image height={420} width={420} alt="profile" src="/profile.jpg" className=" object-fill size-[80%] border-2 rounded-full ring-4 ring-primary ring-offset-4 ring-offset-background"/>
        </div>
      </div>
    </section>
  );
