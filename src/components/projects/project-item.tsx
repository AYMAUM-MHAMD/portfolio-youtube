...
const ProjectItem: FC<ProjectItemProps> = ({project}) => {
  return (
    ...
    <DialogTrigger asChild>
      <ProjectCard imageUrl={urlForImage(project.images[0])} title={project.title}/>
    </DialogTrigger>
    <DialogContent className='p-0 sm:max-w-4xl lg:max-w-7xl'>
      ...
      <div className="grid lg:grid-cols-2 p-4 max-h-[85vh] overflow-x-hidden overflow-y-auto">
